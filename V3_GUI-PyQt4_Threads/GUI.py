...
class Ui_Feutrage(object):
    def setupUi(self, Feutrage):
        ...
        self.pb_closePort = QtGui.QPushButton(Feutrage)
        ...
        self.pb_closePort.setDefault(True)
        self.pb_closePort.setObjectName(_fromUtf8("pb_closePort"))
        self.gridLayout.addWidget(self.pb_closePort, 2, 4, 1, 1)
        ...
        self.sb_y.setProperty("value", 20)
        ...
        self.sb_x.setProperty("value", 20)
        ...
        self.sb_axis_z.setProperty("value", 5)
        ...
        self.pb_generateGCode = QtGui.QPushButton(self.tab_3)
        self.pb_generateGCode.setEnabled(False)
        self.pb_generateGCode.setObjectName(_fromUtf8("pb_generateGCode"))
        self.gridLayout_2.addWidget(self.pb_generateGCode, 0, 0, 1, 1)
        self.pte_displayGCode = QtGui.QPlainTextEdit(self.tab_3)
        ...
        self.pb_clear = QtGui.QPushButton(self.tab_4)
        self.pb_clear.setObjectName(_fromUtf8("pb_clear"))
        self.gridLayout_3.addWidget(self.pb_clear, 0, 0, 1, 1)
        self.pte_gcodeReturn = QtGui.QPlainTextEdit(self.tab_4)
        self.pte_gcodeReturn.setReadOnly(True)
        self.pte_gcodeReturn.setObjectName(_fromUtf8("pte_gcodeReturn"))
        self.gridLayout_3.addWidget(self.pte_gcodeReturn, 1, 0, 1, 2)
        ...
        self.lbl_lines = QtGui.QLabel(Feutrage)
        self.lbl_lines.setObjectName(_fromUtf8("lbl_lines"))
        self.gridLayout.addWidget(self.lbl_lines, 2, 5, 1, 1)
    ...
    def retranslateUi(self, Feutrage):
        ...
        self.pb_closePort.setText(_translate("Feutrage", "Close", None))
        self.pb_openPort.setText(_translate("Feutrage", "Connect", None))
        ...
        self.pb_generateGCode.setText(_translate("Feutrage", "Générer le GCode", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("Feutrage", "Génération du GCode", None))
        self.pb_start.setText(_translate("Feutrage", "Lancer", None))
        self.pb_clear.setText(_translate("Feutrage", "Effacer", None))
        ...
        self.lbl_lines.setText(_translate("Feutrage", "0/0", None))
